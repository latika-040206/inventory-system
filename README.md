...
1. List All Products: Enter `1` at the main menu to view active inventory, prices, and product-specific attributes.
2. Purchase an Item: Enter `2`, input product ID `E101`, and enter quantity `4`. The system validates available stock, calculates a bulk discount, prints an itemized receipt, and decrements stock in `data/inventory.csv`.
3. Restock: Enter `3`, input product ID `P201`, and enter `20` to restock.
4. Exit: Enter `4` to terminate the session safely.
